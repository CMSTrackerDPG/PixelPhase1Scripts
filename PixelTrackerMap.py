...
# baseBarrelTranslateX, baseBarrelTranslateY = 25, 400
barrelSubShiftX, barrelSubShiftY = 30, 60
barrelScaleX, barrelScaleY = 4, -8
barrelLadderShift = [0, 14, 44, 90]

# baseForwardTranslateX, baseForwardTranslateY = 150, 0
...
class PixelTrackerMap:
  def __init__(self, inputFileName):
    ...
    self.inputModules = {}
    self.SVGStream = ""
    self.cablingInfo = pickle.load(open("DATA/cablingDic.pkl" ,"rb"))
  ...
  def DrawMap(self):
    ...
    # self.SVGStream = self.SVGStream + "<g transform=\"translate(" + str(baseBarrelTranslateX) + ", " + str(baseBarrelTranslateY) + ")\">\n"
    ...
    # self.SVGStream = self.SVGStream + "<g transform=\"translate(" + str(baseForwardTranslateX) + ", " + str(baseForwardTranslateY) + ")\">\n"
  ...
  def __GetPolygonInfo(self, line):
    ...
    if rawId in self.cablingInfo:
      infoDic = self.cablingInfo[rawId]
  ...
  def __PrintHeader(self):
    ...
    print("<svg id=\"mainMap\" x=\"0\" y=\"0\" viewBox=\"0 0  2000 1000\" width=\"2000\" height=\"1000\" onload=\"PixelTrackerShow.init()\">")
  def __PrintFooter(self):
    ...
    print("<foreignObject id=\"infoTable\" visibility=\"hidden\"  x=\"100\" y=\"100\" width=\"600\" height=\"300\" >")
